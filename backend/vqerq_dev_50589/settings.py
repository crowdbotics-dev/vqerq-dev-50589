"""
Django settings for vqerq_dev_50589 project.
...
ROOT_URLCONF = 'vqerq_dev_50589.urls'
...
WSGI_APPLICATION = 'vqerq_dev_50589.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vqerq_dev_50589 API",
    "DESCRIPTION": "API documentation for vqerq_dev_50589 App",
    "VERSION": "v1",
}
